...
<head>
    ...
    <title>Career Wave Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        ...
        <!-- Navbar -->
        @include('hcpanel.admin.components.header')
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        @include('hcpanel.admin.components.left_sidebar')
        ...
        <!-- /.content-wrapper -->
        @include('hcpanel.admin.components.footer')
