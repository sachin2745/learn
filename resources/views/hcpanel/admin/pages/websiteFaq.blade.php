...
@section('content')
    ...
    <div class="container-fluid card px-4 pt-2">
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="faqList" role="tabpanel"
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Manage Website Faq's</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($faqList as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->faqId }}</td>
                                        <td>{{ $item->faqTitle }}</td>
                                        <td>{!! Str::words($item->faqDescription, 30) !!}</td>
                                        <td>{{ $item->faqStatus == 0 ? 'Active' : 'Inactive' }}</td>

                                        <td class="d-flex justify-content-center align-items-center">
                                            <a href="#editFaq" data-faq-id="{{ $item->faqId }}" role="tab"
                                            ...
                                            <div class="d-flex ml-3" style="margin-top: -2px;">
                                                @if ($item->faqStatus == 0)
                                                    <form action="/updateFaqStatus/{{ $item->faqId }}" method="post">
            ...
            <div class="tab-pane fade" id="addFaq" role="tabpanel" aria-labelledby="pills-addFaq-tab">
                <form autocomplete="off" action="{{ route('admin.addFaq') }}" method="POST"
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" name="faqTitle" id="faqTitle" placeholder="Enter Faq Title"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea class="form-control col-md-7 col-xs-12 " id="faqDescription" name="faqDescription"
            ...
            <div class="tab-pane fade " id="editFaq" role="tabpanel" aria-labelledby="pills-editFaq-tab">
                <form autocomplete="off" id="updateFaq" method="POST" class="x_content new_x_content"
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" name="faqTitle" id="edit_faqTitle" placeholder="Enter Faq Title"
                                required="required" type="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea class="form-control col-md-7 col-xs-12 " id="edit_faqDescription" name="faqDescription"
                                placeholder="Enter Faq Description"></textarea>
                        </div>
                    </div>    
    ...
    <script>
        $(document).ready(function() {
            $('#edit_faqDescription').summernote({
            ...
            $('.editFaqBtn').on('click', function() {
                ...
                var url = "{{ route('admin.fetchFaqContent', ':faqId') }}";
                url = url.replace(':faqId', faq_id);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#edit_faqTitle').val(data.faqTitle);  
                        $('#edit_faqDescription').summernote('code', data
                            .faqDescription);

                        $('#updateFaq').attr('action',
                            "{{ route('admin.updateFaq', '') }}/" + faq_id);
                    },
